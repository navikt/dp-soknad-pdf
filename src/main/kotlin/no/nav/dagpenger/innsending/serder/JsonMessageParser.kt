...
internal fun JsonMessage.dokumentSpråk(): Innsending.InnsendingsSpråk = when (this["dokument_språk"].asText()) {
...
internal fun JsonMessage.innsendtTidspunkt(): ZonedDateTime =
